...
const FeaturedCoach = () => {
  return (
    <div className="bg-white rounded border shadow">
      <h2 className="text-[#000229] font-bold text-sm  font-redhat p-3">Featured Coach</h2>

      <div className="mb-1">
        <div className="rounded  h-[147px] w-full bg-[url('/referee.png')] bg-cover bg-top flex flex-col justify-center text-white font-redhat pl-5 text-xs">
      ...
      <div className="text-sm font-redhat">
        <div className="flex justify-between items-center py-1 px-3 border-b">
          ...
          <div className="flex gap-3 items-center">
            <h3 className="font-bold text-sm">UI Pioneers</h3>
