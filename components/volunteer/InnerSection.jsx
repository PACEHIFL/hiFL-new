...
const InnerSection = ({ title, img, parag, lower, arrow, item }) => {
  return (
    <div className="flex align-top mb-5 h-[100%]  flex-wrap ">
      <div className="hidden lg:hidden xl:inline  w-1/2 h-auto  ">
        <img src={img} alt="" width="100%" height="100%" className="h-full object-cover" />
      </div>
      <div className='w-[90%] xl:w-1/2 lg:w-[100%] md:w-[100%] p-10 lg:pt-6 xl:pt-16 bg-[url("/volunteer-bg.png")] bg-cover bg-right bg-no-repeat mix-blend-darken bg-[#000229] flex flex-col justify-between '>
