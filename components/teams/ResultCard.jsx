    ...
    <div className="grid grid-cols-3 bg-[#F8F8F8] px-10 py-3 mb-6 hover:bg-[#FFEBA4]">
      <div className="flex items-center justify-start col-span-2">
        <div className="flex justify-center items-center">
          <span className="font-bold md:text-lg">{data?.HomeTeam?.TeamAbbreviation}</span>
        ...
        <div className="flex justify-center items-center">
          ...
          <span className="font-bold md:text-lg capitalize">{data.AwayTeam.TeamAbbreviation}</span>
        </div>
      </div>
      <div className="flex items-center justify-between col-span-1">
        <span>
          {" "}
          <Moment format="MMMM Do YYYY" date={data.MatchDate} />{" "}
        </span>
